...
void CClientDlg::OnConnect() 
{
	...
	{
		GetDlgItem(IDC_MSG)->SetWindowText("遠端電腦連接失敗!!");
		return;
	}
	else
	{
		GetDlgItem(IDC_MSG)->SetWindowText("連線成功!!");
	}
...
void CClientDlg::OnSend() 
{
	...
	{
		GetDlgItem(IDC_MSG)->SetWindowText("傳送成功!!");
	}
...
void CClientDlg::OnRecive() 
{
	...
	{
		buff[nRecv] = '\0';
		GetDlgItem(IDC_MSG)->SetWindowText(strcat("接收資料",buff));
	}
